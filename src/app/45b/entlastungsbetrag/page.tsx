...
export default function EntlastungsbetragPage() {
  const { monthlyAmount, yearlyAmount } = settings.entlastungsbetrag;
      ...
      <section className="bg-white" style={{ padding: "var(--section-padding-y) 0" }}>
        <div className="max-w-[900px] mx-auto px-6 md:px-10">
          ...
          <p className="mb-8" style={{ fontSize: "var(--font-size-body)", color: "#455A64", lineHeight: 1.65 }}>
            Der Entlastungsbetrag nach §45b SGB XI steht jedem Versicherten mit Pflegegrad 1 bis 5 zu, der zu Hause gepflegt wird. Er beträgt {monthlyAmount} € pro Monat und kann für anerkannte Angebote zur Unterstützung im Alltag genutzt werden.
          </p>
          ...
          <h2 className="mb-6" style={{ fontFamily: "var(--font-outfit), 'Outfit', sans-serif", fontSize: "var(--font-size-h3)", fontWeight: 700, color: "#0D2137" }}>
            Voraussetzungen
          </h2>
          ...
          <div className="p-6 rounded-[16px] bg-[#FFF8F0] border border-[#F5E6D3]">
            ...
            <p style={{ fontSize: "16px", color: "#455A64", lineHeight: 1.65 }}>
              Nicht genutzte Entlastungsbeträge verfallen nicht sofort. Sie können ins Folgequartal übertragen werden. Beträge aus dem Vorjahr können bis zum {settings.entlastungsbetrag.rolloverDeadline} des Folgejahres noch eingesetzt werden. So können Sie bis zu {settings.entlastungsbetrag.maxRolloverMonths} Monate ansparen.
            </p>
          </div>
        </div>
      </section>
